...
import PlainNavbar from "./components/plain navbar/navbar";
        ...
        <>
          ...
          <Routes>
            ...
            <Route
              ...
              element={<Authentication mode="Register" role="Customer" />}
            />
            <Route
              path="/Customerlogin"
              element={<Authentication mode="Login" role="Customer" />}
            />
            <Route
              path="/Sellerregister"
              element={<Authentication mode="Register" role="Seller" />}
            />
            <Route
              path="/Sellerlogin"
              element={<Authentication mode="Login" role="Seller" />}
            />
          </Routes>
        </>
      )}
